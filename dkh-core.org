...
#+begin_src emacs-lisp :tangle no
 ...
 (setq wg-prefix-key (kbd "C-8"))

(global-set-key (kbd "C-c e") 'wg-switch-to-workgroup-at-index-0)
(global-set-key (kbd "C-c p") 'wg-switch-to-workgroup-at-index-9)
(global-set-key (kbd "C-c d") 'wg-switch-to-workgroup-at-index-7)
(global-set-key (kbd "C-c Z") 'wg-switch-to-workgroup-at-index-6)
(global-set-key (kbd "C-c g") 'wg-switch-to-workgroup-at-index-1)
(global-set-key (kbd "C-c E") 'wg-switch-to-workgroup-at-index-3)
(global-set-key (kbd "C-c j") 'wg-switch-to-workgroup-at-index-2)
(global-set-key (kbd "C-c m") 'wg-switch-to-workgroup-at-index-5) ;; main
(global-set-key (kbd "C-c o") 'wg-switch-to-workgroup-at-index-4)
(global-set-key (kbd "C-c s") 'wg-switch-to-workgroup-at-index-8)
(global-set-key (kbd "C-c <DEL>") 'wg-switch-to-previous-workgroup) ;;C-z a C-z C-a
