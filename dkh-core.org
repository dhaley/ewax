...
;; (setq erc-text-matched-hook (quote (erc-log-matches erc-hide-fools my-erc-hook)))
(setq erc-text-matched-hook (quote (erc-log-matches erc-hide-fools)))
...
(require 'irc-secrets "~/git/.emacs.d/.secret/irc-secrets.el.gpg")

;;(defun run-irc-secrets-hook ()
;;  (require 'irc-secrets "~/git/.emacs.d/.secret/irc-secrets.el.gpg")
;;)
;;
;;(add-hook 'erc-before-connect 'run-irc-secrets-hook)
...
(setq erc-modules (quote (autojoin button completion dcc fill identd irccontrols list log match menu move-to-prompt netsplit networks noncommands readonly replace ring scrolltobottom services smiley stamp spelling track highlight-nicknames)))

(setq erc-nick "dkh")
(setq erc-port 6667)
(setq erc-priority-people-regexp "\\`[^#].+")
...
(setq erc-autoaway-message "I need a cappuccino")
...
(setq erc-track-faces-priority-list (quote (erc-error-face (erc-nick-default-face erc-current-nick-face) erc-current-nick-face erc-keyword-face (erc-nick-default-face erc-pal-face) erc-pal-face erc-nick-msg-face erc-direct-msg-face)))
;; (setq erc-track-faces-priority-list '(erc-current-nick-face erc-keyword-face erc-pal-face erc-nick-msg-face erc-direct-msg-face))
...
(setq erc-ignore-list (quote ("rudybot!.*")))
...
(setq erc-log-channels-directory "~/git/.emacs.d/.erc/logs/")
               ...
               :password (funcall
                          (plist-get
                           (car (auth-source-search :host "asimov.freenode.net"
                                                    ...
                                                    :port 6667))
                           :secret)))
      (erc-tls :server "irc.debian.org"
               :port 6697
               :nick "dkh"
               :password (funcall
                          (plist-get
                           (car (auth-source-search :host "irc.debian.org"
                                                    :user "dkh"
                                                    :type 'netrc
                                                    :port 6667))
                           :secret))))
